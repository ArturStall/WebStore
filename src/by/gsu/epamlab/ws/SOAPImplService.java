 ...
 * 
 */
@WebServiceClient(name = "SOAPImplService", targetNamespace = "http://ws.epamlab.gsu.by/", wsdlLocation = "http://localhost:8080/WebStoreSOAP/SOAP?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPIMPLSERVICE_QNAME = new QName("http://ws.epamlab.gsu.by/", "SOAPImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebStoreSOAP/SOAP?wsdl");
    ...
    public SOAP getSOAPImplPort() {
        return super.getPort(new QName("http://ws.epamlab.gsu.by/", "SOAPImplPort"), SOAP.class);
    }
    ...
    public SOAP getSOAPImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.epamlab.gsu.by/", "SOAPImplPort"), SOAP.class, features);
    }
